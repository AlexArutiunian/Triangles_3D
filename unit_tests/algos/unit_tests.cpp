...
TEST(Intersect2D, segments){
    ...
    EXPECT_FALSE(is_intersect_segment_2d(seg1, seg2));
    EXPECT_FALSE(is_intersect_segment_2d(seg2, seg1));

    seg1 = {{0, 0, 0}, {1, 1, 0}};
    seg2 = {{0, 1, 0}, {1, 0, 0}};

    EXPECT_TRUE(is_intersect_segment_2d(seg1, seg2));
    EXPECT_TRUE(is_intersect_segment_2d(seg2, seg1));
}
...
TEST(Intersect, segments_spec_cases){
    ...
    EXPECT_FALSE(geom::is_intersect_segment_2d(seg1, seg2));
    EXPECT_FALSE(geom::is_intersect_segment_2d(seg2, seg1));


    seg1 = {{0, 1, 0}, {1, 0, 0}};
    seg2 = {{2, -1, 0}, {-1, 2, 0}};
    EXPECT_TRUE(geom::is_intersect_segment_2d(seg1, seg2));
    EXPECT_TRUE(geom::is_intersect_segment_2d(seg2, seg1));
}
...
TEST(Intersect, triangles_3D_10){
    geom::triangle<T> tr1 = {{1, 0, 0}, {0, 1, 0}, {0, 0, 1}};
    geom::triangle<T> tr2 = {{3, 0, 0}, {0, 3, 0}, {0, 0, 3}};
